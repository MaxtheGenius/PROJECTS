-- Create a complex SQL query to analyze monthly sales trends by product category over the past 3 years
...
VALUES ('Smartphone', 1, 499.99, 150),
       ('Laptop', 1, 999.99, 80),
       ('Sofa', 2, 299.99, 60),
       ('T-shirt', 3, 19.99, 200);
...
-- Complex Query to analyze monthly sales trends by product category over the past 3 years
